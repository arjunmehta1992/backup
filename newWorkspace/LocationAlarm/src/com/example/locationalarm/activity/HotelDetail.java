...
public class HotelDetail extends FragmentActivity {

	private TextView nameset, addressset, phonenumberset;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.e("hello", "" + phonenumber);
		nameset.setText(name);
		addressset.setText(address);
		phonenumberset.setText(phonenumber);

		gpsTracker = new GPSTracker(HotelDetail.this);
		latitude = gpsTracker.getLatitude();
		longitude = gpsTracker.getLongitude();
		Log.e("both", "" + latitude + "" + longitude);
