...
public class DBHelper extends SQLiteOpenHelper {
	...
	public int changePassword(LoginModel model) {
		...
		Cursor c=db.rawQuery("select "+LOGIN_USERNAME +" from "+TABLENAME+" where "+LOGIN_USERNAME+" = '" +model.getUsername().toString()+"'" , null);
		int a=0;
		if(c.getCount()==1)
		{
		ContentValues values = new ContentValues();
