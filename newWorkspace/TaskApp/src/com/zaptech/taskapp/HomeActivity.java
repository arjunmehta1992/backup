	...
	public class LoadData extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			googleMap.addMarker(new MarkerOptions().position(new LatLng(Double
					.parseDouble(obj_LocationModel.getLatitude()), Double
					.parseDouble(obj_LocationModel.getLongitude()))));
			...
			urlString.append(obj_LocationModel.getLatitude());
			urlString.append(",");
			urlString.append(obj_LocationModel.getLongitude());
			Log.i("", "URL=====" + urlString);
