...
public class MainActivity extends Activity implements OnClickListener {
	...
	private ImageButton playButton, pauseButton, forword, rewind;
	...
	public void init() {
		...
		forword = (ImageButton) findViewById(R.id.imageButton3);
		rewind = (ImageButton) findViewById(R.id.imageButton4);
	...
	private void play() {
		...
		Toast.makeText(MainActivity.this, "Playing sound", Toast.LENGTH_SHORT)
				.show();
		mediaPlayer.start();
