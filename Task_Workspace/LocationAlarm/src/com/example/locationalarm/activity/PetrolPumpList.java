...
public class PetrolPumpList extends Activity {
	private DatabaseHelper helper;
	private ListView listView = null;
	private Button button;
	ArrayList<PetrolPump> myList;
	ArrayList<PetrolPump> arrayList;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myList = (ArrayList<PetrolPump>) getIntent().getSerializableExtra(
				"mylist");
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(PetrolPumpList.this,
