...
public class CoverFlowDemo extends Activity {
	...
	public class ImageAdapter extends BaseAdapter {
		...
		private Integer[] mImageIds = { R.drawable.car3,
				R.drawable.car11, R.drawable.car4,
				R.drawable.car2, R.drawable.f1,
				R.drawable.lambo, R.drawable.f2,
				R.drawable.l2, R.drawable.l1
		};
