...
public class HomeActiivity extends ActionBarActivity implements OnClickListener {
	...
	// "http://pcsalt.com/postservice/?format=xml";
	public static final String Url = "http://skillmuni.cloudapp.net/smservice/Api/Search?category=0&organization=1";
	...
	class RetrieveFeedTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			NodeList nl = doc.getElementsByTagName("SearchResponce");

			for (int i = 0; i < nl.getLength(); i++) {

				HashMap<String, String> map = new HashMap<String, String>();
				Element e = (Element) nl.item(i);
				map.put("id", parser.getValue(e, "CONTENT_QUESTION"));
				map.put("name", parser.getValue(e, "CONTENT_QUESTION"));
				map.put("cost", parser.getValue(e, "ID_CONTENT"));
				map.put("description", parser.getValue(e, "ID_CONTENT_LEVEL"));
				list_Pizza.add(map);
